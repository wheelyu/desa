...
<body>
    <center>
        ...
        <table width="610" align="center">
            <tr>
                <font size="3" align="center" style="text-decoration: underline 2px;">SURAT KETERANGAN KEHILANGAN</font><br>
            </tr>
            <tr>
                <td align="center">
        ...
        <table width="610">
            <tr>
                <td>
                    <font size="2">Menurut laporan Rt/Rw setempat bahwa benar orang tersebut diatas benar warga Penduduk Kampung Kesumadadi Kecamatan Bekri Kabupaten Lampung Tengah dan benar orang tersebut telah kehilangan <!--Barang yang hilang-->pada hari <!--nama hari--> Tanggal <!--angka tgl--> <!--Bulan--><!--Tahun--> Berisikan:</font>
                </td>
            </tr>
        </table>
        ...
        <table width="550">
            <tr>
                <td colspan="2" style="font-size: 12px;" align="left">1.<input type="text" id="barang" name="barang" placeholder="barang"></td>
            </tr>
            <tr>
            <td colspan="2" style="font-size: 12px;" align="left"><input type="text" id="barang2" name="barang2"></td>
            </tr>
        </table>
        ...
        <table width="610">
            <tr>
                <td>
                    <font size="2">Demikian surat keterangan ini dibuat dengan sebenarnya dan diberikan kepada yang bersangkutan agar dapat dipergunakan sebagaimana mestinya.</font>
                </td>
            </tr>
        </table>
        <table width="610">
            <tr>
                <td style="font-size: 12px; width: 100px;"><strong>Pelapor</strong></td>
                <td width="10"><strong>:</strong></td>
                <td style="font-size: 12px;"><input type="text" id="pelapor" name="pelapor" placeholder="pelapor"></td>
            </tr>
            <tr>
                <td style="font-size: 12px; width: 100px;"><strong>Saksi</strong></td>
                <td width="10"><strong>:</strong></td>
        ...
        <table width="550">
            <tr>
                <td colspan="2" style="font-size: 12px;" align="left">1. <input type="text" id="saksi" name="saksi" placeholder="saksi"></td>
            </tr>
            <tr>
                <td colspan="2" style="font-size: 12px;" align="left">2. <input type="text" id="saksi2" name="saksi2" ></td>
            </tr>
        </table>      
        <table width="610">
            <tr>
