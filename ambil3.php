        ...
        <tr>
            ...
            <td>
                <div class="btn-group my-3 ">
                    <a href="surat_keterangan_kematian.php?NIK=<?php echo htmlspecialchars($data['NIK']); ?>&NIKS=<?php echo htmlspecialchars($data2['NIKS']); ?>" class="btn btn-warning" role="button">Tambah data</a>
                </div>
            </td>
        </tr>
        <?php
